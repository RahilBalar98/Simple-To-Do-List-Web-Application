        ...
        return(
            <header>
                <nav className="navbar navbar-expand-md navbar-dark bg-dark">
                    <div><a href="https://www.linkedin.com/in/rahil-balar/"className="navbar-brand">RahilBalar98</a></div>
                    <ul className="navbar-nav">
                        {isUserLoggedIn && <li><Link className="navbar-link" to = "/welcome/RahilBalar98">Home</Link></li>}
